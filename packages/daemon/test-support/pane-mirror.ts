/** Historical parser/render adapter retained only for differential and conformance tests. */
/**
...
import {
  ...
  SPACE_CODE,
  type CellArrays,
} from "../src/tui/mirror/blit.ts";
import { AckWriter } from "../src/tui/mirror/ack-writer.ts";
import { extractSelection, type Cell } from "../src/tui/mirror/selection.ts";
import type { TerminalPaletteProjection } from "../src/tui/mirror/theme.ts";
import { XTERM_PALETTE } from "../src/tui/mirror/ansi-palette.ts";
import {
...
import type {
  ...
  CursorState,
  BlitOptions,
} from "../src/tui/mirror/pane-mirror.ts";
