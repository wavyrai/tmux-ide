...
// Compatibility for callers that already import mission-specific helpers from
// this module. Generic surfaces should import from terminal-text directly.
export { clipTerminal } from "./terminal-text.ts";
