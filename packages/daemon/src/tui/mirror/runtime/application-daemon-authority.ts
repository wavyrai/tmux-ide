...
const authority = createApplicationDaemonAuthority();
export const readApplicationDaemonInfo = authority.read;
export const isApplicationDaemonAlive = authority.isAlive;
export const observeApplicationDaemonGeneration = authority.observe;
export const applicationDaemonEndpoint = authority.endpoint;
export const initializeApplicationSshAuthority = authority.initialize;
export const disposeApplicationDaemonAuthority = authority.dispose;
