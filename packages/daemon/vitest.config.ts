...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "src/terminal/pane-stream/*.test.ts",
      ...
      "src/command-center/resources/workspace-changes-authority.test.ts",
      "src/command-center/resources/workspace-resource-routes.test.ts",
      "src/control/*.test.ts",
      "src/tui/*.test.ts",
