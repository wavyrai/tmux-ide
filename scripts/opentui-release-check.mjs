...
const sshTests = [
  ...
  "packages/daemon/src/tui/mirror/runtime/application-route-connection.test.ts",
...
const sshSources = [
  ...
  "packages/daemon/src/tui/mirror/runtime/application-fleet-preview.ts",
  "packages/daemon/src/tui/mirror/runtime/application-fleet-tabs.ts",
  "packages/daemon/src/tui/mirror/runtime/application-route-connection.ts",
...
const checks = [
  ...
  {
    boundary: "OpenTUI native session admission unit tests",
    command: "pnpm",
    args: [
      "--filter",
      "@tmux-ide/daemon",
  ...
  },
  {
    ...
    args: [
      ...
      "vitest",
      "run",
      ...sshTests.map((path) => path.replace(/^packages\/daemon\//u, "")),
    ],
  },
  {
    ...
    args: [
      ...
      "src/tui/mirror/runtime/application-session-focus-owner.test.ts",
      "src/tui/mirror/runtime/application-terminal-interaction-controller.test.ts",
    ],
  },
  {
  ...
  {
    boundary: "OpenTUI multi-server routing and native coexistence",
    command: "pnpm",
    args: [
      "--filter",
      "@tmux-ide/daemon",
      ...
      "--config",
      "vitest.live.config.ts",
      "src/lib/tmux-server-owner-live.test.ts",
